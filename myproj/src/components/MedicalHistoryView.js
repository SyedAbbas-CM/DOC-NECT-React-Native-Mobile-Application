    ...
    return (  
      <ScrollView>
        <View style = {styles.root}>
          ...
          <Card elevation={1} style = {{...styles.card, borderWidth:1, borderColor:"#007fff"}}>
            <Card.Title titleStyle={{fontSize:24, minHeight:'auto'}} title="Knee Surgery Required?" subtitle="Status: recovered" left={LeftContent} />
            <Card.Content>
              <Paragraph>Symptoms: Unable to walk on my right knee. Constant throbbing in my knee-cap.</Paragraph>
              <Paragraph>I suspect that my Kneecap has been fractured. Collided hard with a Bear while playing Soccer in the Artic. Included X-ray images. Plz help.</Paragraph>
            </Card.Content>
            <Card.Actions>
              <Button mode="text" textColor={theme.colors.primary}>Edit</Button>
            </Card.Actions>
